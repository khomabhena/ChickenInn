...
public class DBOperations extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "chicken_inn.db";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + DBContract.Shops.TABLE_NAME);
    ...
    Cursor getShops(SQLiteDatabase db) {
        Cursor cursor;
        String[] projections = {
                DBContract.Shops.ID,
                DBContract.Shops.UNIQUE_KEY,
                DBContract.Shops.CITY,
                DBContract.Shops.ADDRESS,
                DBContract.Shops.MERCHANT,
                DBContract.Shops.PREFIX,
                DBContract.Shops.WHATSAPP
        };
// + DBContract.Event.LOCAL_UID + "='" + localUid + "'"
        cursor = db.query(
                true,
                DBContract.Shops.TABLE_NAME, projections,
                null,
                null,
                DBContract.Shops.UNIQUE_KEY,
                null,
                DBContract.Shops.CITY + " DESC",
                null
        );
    ...
    List<String> getShopKeys(SQLiteDatabase db) {
        Cursor cursor;
        String[] arrayMax = new String[]{""};
        List<String> listKeys = new LinkedList<>(Arrays.asList(arrayMax));

        String[] projections = {DBContract.Shops.UNIQUE_KEY};
        cursor = db.query(true, DBContract.Shops.TABLE_NAME, projections,
                null,
                null,
                null,
                null,
        ...
        while (cursor.moveToNext()) {
            listKeys.add(cursor.getString(cursor.getColumnIndex(DBContract.Shops.UNIQUE_KEY)));
        }
        cursor.close();
    ...
    Cursor getOrders(SQLiteDatabase db) {
        Cursor cursor;
        String[] projections = {
                DBContract.Orders.ID,
                DBContract.Orders.TYPE,
                DBContract.Orders.ORDER_ID,
                DBContract.Orders.NAME,
                DBContract.Orders.PRICE,
                DBContract.Orders.TIMESTAMP,
                DBContract.Orders.MESSAGE,
                DBContract.Orders.ORDER_NUMBER
        };
// + DBContract.Event.LOCAL_UID + "='" + localUid + "'"
        cursor = db.query(
                true,
    ...
    List<String> getOrderKeys(SQLiteDatabase db) {
        ...
        String[] projections = {DBContract.Orders.MESSAGE};
        cursor = db.query(true, DBContract.Orders.TABLE_NAME, projections,
                null,
                null,
                null,
                null,
        ...
        while (cursor.moveToNext()) {
            listKeys.add(cursor.getString(cursor.getColumnIndex(DBContract.Orders.MESSAGE)));
        }
        cursor.close();
    ...
    String[] getApprovalCodeKeys(SQLiteDatabase db, String localUid) {
        ...
        String[] arrayMax = new String[]{""};
        List<String> listKeys = new LinkedList<>(Arrays.asList(arrayMax));
        String[] projections = {DBContract.Shops.ADDRESS};
        cursor = db.query(true, DBContract.Shops.TABLE_NAME, projections,
                DBContract.Shops.LOCAL_UID + "='" + localUid + type + "'",
                null, null, null, null, null);

        while (cursor.moveToNext()) {
            listKeys.add(cursor.getString(cursor.getColumnIndex(DBContract.Shops.ADDRESS)));
        }
        cursor.close();
    ...
    int getPoints(SQLiteDatabase db, String type, String localUid) {
        ...
        cursor = db.query(
                true,
                DBContract.Orders.TABLE_NAME, projections,
                DBContract.Orders.TYPE + "='" + type +"' AND " +
                        DBContract.Orders.LOCAL_UID + "='" + localUid + type + "'",
                null,
                null,
                null,
                DBContract.Orders.ID + " ASC",
                null
        );
        int count = cursor.getCount();
        cursor.close();
    ...
    private static final String ApprovalCodes = "CREATE TABLE "+ DBContract.Shops.TABLE_NAME +"("+
            DBContract.Shops.ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
            DBContract.Shops.LOCAL_UID + " TEXT, " +
            DBContract.Shops.CITY + " TEXT, " +
            DBContract.Shops.ADDRESS + " TEXT, " +
            DBContract.Shops.MERCHANT + " TEXT, " +
            DBContract.Shops.UNIQUE_KEY + " TEXT, " +
            DBContract.Shops.PREFIX + " TEXT, " +
            DBContract.Shops.WHATSAPP + " TEXT, " +
            DBContract.Shops.COl_7 + " TEXT, " +
            DBContract.Shops.COl_8 + " TEXT, " +
            DBContract.Shops.COl_9 + " TEXT, " +
            DBContract.Shops.COl_10 + " TEXT, " +
            DBContract.Shops.COl_11 + " TEXT, " +
            DBContract.Shops.COl_12 + " TEXT, " +
            DBContract.Shops.COl_13 + " TEXT, " +
            DBContract.Shops.COl_14 + " TEXT, " +
            DBContract.Shops.COl_15 + " TEXT, " +
            DBContract.Shops.COl_16 + " TEXT, " +
            DBContract.Shops.COl_17 + " TEXT, " +
            DBContract.Shops.COl_18 + " TEXT, " +
            DBContract.Shops.COl_19 + " TEXT, " +
            DBContract.Shops.COl_20 +" TEXT);";

    private static final String LoyaltyPoints = "CREATE TABLE "+ DBContract.Orders.TABLE_NAME + "("+
            DBContract.Orders.ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
            DBContract.Orders.LOCAL_UID + " TEXT, " +
            DBContract.Orders.TYPE + " TEXT, " +
            DBContract.Orders.ORDER_ID + " TEXT, " +
            DBContract.Orders.NAME + " TEXT, " +
            DBContract.Orders.PRICE + " TEXT, " +
            DBContract.Orders.TIMESTAMP + " TEXT, " +
            DBContract.Orders.MESSAGE + " TEXT, " +
            DBContract.Orders.ORDER_NUMBER + " TEXT, " +
            DBContract.Orders.COl_8 + " TEXT, " +
            DBContract.Orders.COl_9 + " TEXT, " +
            DBContract.Orders.COl_10 + " TEXT, " +
            DBContract.Orders.COl_11 + " TEXT, " +
            DBContract.Orders.COl_12 + " TEXT, " +
            DBContract.Orders.COl_13 + " TEXT, " +
            DBContract.Orders.COl_14 + " TEXT, " +
            DBContract.Orders.COl_15 + " TEXT, " +
            DBContract.Orders.COl_16 + " TEXT, " +
            DBContract.Orders.COl_17 + " TEXT, " +
            DBContract.Orders.COl_18 + " TEXT, " +
            DBContract.Orders.COl_19 + " TEXT, " +
            DBContract.Orders.COl_20 +" TEXT);";
