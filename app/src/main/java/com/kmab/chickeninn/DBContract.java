...
public final class DBContract {
    ...
    static abstract class Shops {
        static final String TABLE_NAME = "table_one";
        static final String ID = "_id";
        static final String LOCAL_UID = "local_uid";
        static final String CITY = "col_1";
        static final String ADDRESS = "col_2";
        static final String MERCHANT = "col_3";
        static final String UNIQUE_KEY = "col_4";
        static final String PREFIX = "col_5";
        static final String WHATSAPP = "col_6";
    ...
    static abstract class Orders {
        ...
        static final String ORDER_ID = "col_2";
        static final String NAME = "col_3";
        static final String PRICE = "col_4";
        static final String TIMESTAMP = "col_5";
        static final String MESSAGE = "col_6";
        static final String ORDER_NUMBER = "col_7";
        static final String COl_8 = "col_8";
        static final String COl_9 = "col_9";
        static final String COl_10 = "col_10";
        static final String COl_11 = "col_11";
